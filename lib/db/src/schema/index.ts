...
export const registerEnteSchema = z.object({
  ...
  acceptPrivacy: z.literal(true, { message: "Devi accettare l'informativa sulla privacy" }),
  acceptTerms: z.literal(true, { message: "Devi accettare i termini e condizioni" }),
});

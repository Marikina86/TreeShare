/** Initial HTML seed content for all three legal documents. */

export const TERMS_HTML = `<p>Benvenuto/a su TreeShare, una piattaforma social dedicata alla condivisione di alberi piantati, iniziative ambientali e attività legate alla sostenibilità. L'utilizzo della piattaforma è soggetto ai presenti Termini e Condizioni ("Termini"). Utilizzando il servizio, accetti integralmente quanto segue.</p>
...
export const PRIVACY_HTML = `<p>Benvenuto/a su TreeShare, una piattaforma social dedicata alla condivisione di alberi piantati e iniziative ambientali. La presente Privacy Policy descrive come raccogliamo, utilizziamo, proteggiamo e trattiamo i tuoi dati personali in conformità al Regolamento (UE) 2016/679 ("GDPR").</p>
...
export const COOKIE_HTML = `<p>La presente Cookie Policy descrive come TreeShare utilizza i cookie e tecnologie di tracciamento simili quando accedi alla piattaforma.</p>

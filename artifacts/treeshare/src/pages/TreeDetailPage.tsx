          ...
          {isOwner && (
            <div className="flex gap-2 flex-wrap justify-end">
              ...
              {(() => {
                ...
                const atLimit = updateCount >= 3;
                return (
                  <button
                    onClick={() => !atLimit && setShowUpdateForm(!showUpdateForm)}
                    disabled={atLimit}
                    title={atLimit ? "Limite di 3 aggiornamenti raggiunto" : "Aggiungi aggiornamento fotografico"}
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    {isOwner && !photo.isMain && (
                      <button
                        ...
                        className="flex-shrink-0 w-7 h-7 flex items-center justify-center rounded-full text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-colors disabled:opacity-50"
                      >

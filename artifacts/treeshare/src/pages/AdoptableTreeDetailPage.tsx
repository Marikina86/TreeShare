...
const T = {
  it: {
    ...
    of: "di",
    fee: "di cui 30% trattenuto dalla piattaforma",
    ...
    stripeDesc: "Collega il tuo account bancario per ricevere direttamente gli importi delle adozioni (il 70% ti viene accreditato automaticamente da Stripe).",
  ...
  en: {
    ...
    of: "of",
    fee: "of which 30% retained by the platform",
    ...
    stripeDesc: "Connect your bank account to receive adoption payments directly (70% is automatically credited to you by Stripe).",

...
export const translations = {
  it: {
    nav: { feed: "Feed", map: "Mappa", plant: "Pianta", events: "Eventi", profile: "Profilo", alerts: "Avvisi", tips: "Consigli", adopt: "Adotta" },
  ...
  en: {
    nav: { feed: "Feed", map: "Map", plant: "Plant", events: "Events", profile: "Profile", alerts: "Alerts", tips: "Tips", adopt: "Adopt" },
  ...
  fr: {
    nav: { feed: "Fil", map: "Carte", plant: "Planter", events: "Événements", profile: "Profil", alerts: "Alertes", tips: "Conseils", adopt: "Adopter" },
  ...
  pt: {
    nav: { feed: "Feed", map: "Mapa", plant: "Plantar", events: "Eventos", profile: "Perfil", alerts: "Avisos", tips: "Dicas", adopt: "Adotar" },
  ...
  es: {
    nav: { feed: "Feed", map: "Mapa", plant: "Plantar", events: "Eventos", profile: "Perfil", alerts: "Avisos", tips: "Consejos", adopt: "Adoptar" },
  ...
  ja: {
    nav: { feed: "フィード", map: "マップ", plant: "植える", events: "イベント", profile: "プロフィール", alerts: "お知らせ", tips: "ヒント", adopt: "養子" },
